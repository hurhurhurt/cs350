...
80100f51:	e8 0a 25 00 00       	call   80103460 <pipeclose>
...
8010105c:	5d                   	pop    %ebp
    return piperead(f->pipe, addr, n);
8010105d:	e9 ae 25 00 00       	jmp    80103610 <piperead>
...
80101178:	5d                   	pop    %ebp
    return pipewrite(f->pipe, addr, n);
80101179:	e9 82 23 00 00       	jmp    80103500 <pipewrite>
  panic("filewrite");
...
80101234:	68 1f 70 10 80       	push   $0x8010701f
...
80101383:	68 35 70 10 80       	push   $0x80107035
...
8010144b:	68 45 70 10 80       	push   $0x80107045
...
80101514:	68 58 70 10 80       	push   $0x80107058
...
8010152c:	68 6b 70 10 80       	push   $0x8010706b
...
80101543:	68 72 70 10 80       	push   $0x80107072
...
80101599:	68 d8 70 10 80       	push   $0x801070d8
...
80101663:	68 78 70 10 80       	push   $0x80107078
...
801017dd:	68 90 70 10 80       	push   $0x80107090
801017e2:	e8 a9 eb ff ff       	call   80100390 <panic>
    panic("ilock");
801017e7:	83 ec 0c             	sub    $0xc,%esp
801017ea:	68 8a 70 10 80       	push   $0x8010708a
...
80101837:	68 9f 70 10 80       	push   $0x8010709f
...
80101ce2:	68 b9 70 10 80       	push   $0x801070b9
80101ce7:	e8 a4 e6 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101cec:	83 ec 0c             	sub    $0xc,%esp
80101cef:	68 a7 70 10 80       	push   $0x801070a7
...
80101f9b:	68 c8 70 10 80       	push   $0x801070c8
...
801020bb:	68 34 71 10 80       	push   $0x80107134
801020c0:	e8 cb e2 ff ff       	call   80100390 <panic>
    panic("idestart");
801020c5:	83 ec 0c             	sub    $0xc,%esp
801020c8:	68 2b 71 10 80       	push   $0x8010712b
...
801020e6:	68 46 71 10 80       	push   $0x80107146
...
80102299:	e8 02 1c 00 00       	call   80103ea0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
8010234a:	68 94 71 10 80       	push   $0x80107194
...
8010247b:	68 c6 71 10 80       	push   $0x801071c6
...
801024eb:	68 cc 71 10 80       	push   $0x801071cc
...
8010266f:	0f b6 8a 00 73 10 80 	movzbl -0x7fef8d00(%edx),%ecx
  shift ^= togglecode[data];
80102676:	0f b6 82 00 72 10 80 	movzbl -0x7fef8e00(%edx),%eax
  shift |= shiftcode[data];
...
8010268c:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
8010268f:	8b 04 85 e0 71 10 80 	mov    -0x7fef8e20(,%eax,4),%eax
...
801026c8:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801026ca:	0f b6 8a 00 73 10 80 	movzbl -0x7fef8d00(%edx),%ecx
...
80102c0a:	68 00 74 10 80       	push   $0x80107400
...
80102cc5:	e8 d6 11 00 00       	call   80103ea0 <sleep>
...
80102e67:	68 04 74 10 80       	push   $0x80107404
...
80102f30:	68 13 74 10 80       	push   $0x80107413
80102f35:	e8 56 d4 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102f3a:	83 ec 0c             	sub    $0xc,%esp
80102f3d:	68 29 74 10 80       	push   $0x80107429
...
80102f54:	83 ec 10             	sub    $0x10,%esp
	cprintf("***Printing in Kernel Space****\n");
80102f57:	68 44 74 10 80       	push   $0x80107444
80102f5c:	e8 4f d7 ff ff       	call   801006b0 <cprintf>
  cprintf("cpu%d: starting %d\n", cpuid(), cpuid());
80102f61:	e8 6a 09 00 00       	call   801038d0 <cpuid>
80102f66:	89 c3                	mov    %eax,%ebx
80102f68:	e8 63 09 00 00       	call   801038d0 <cpuid>
80102f6d:	83 c4 0c             	add    $0xc,%esp
80102f70:	53                   	push   %ebx
80102f71:	50                   	push   %eax
80102f72:	68 65 74 10 80       	push   $0x80107465
80102f77:	e8 34 d7 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102f7c:	e8 1f 28 00 00       	call   801057a0 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102f81:	e8 ca 08 00 00       	call   80103850 <mycpu>
80102f86:	89 c2                	mov    %eax,%edx
...
80102f88:	b8 01 00 00 00       	mov    $0x1,%eax
80102f8d:	f0 87 82 a0 00 00 00 	lock xchg %eax,0xa0(%edx)
  scheduler();     // start running processes
80102f94:	e8 17 0c 00 00       	call   80103bb0 <scheduler>
...
80102fa3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102fa6:	e8 f5 38 00 00       	call   801068a0 <switchkvm>
  seginit();
80102fab:	e8 60 38 00 00       	call   80106810 <seginit>
  lapicinit();
80102fb0:	e8 7b f7 ff ff       	call   80102730 <lapicinit>
  mpmain();
80102fb5:	e8 96 ff ff ff       	call   80102f50 <mpmain>
...
80102fdc:	e8 ff f4 ff ff       	call   801024e0 <kinit1>
  kvmalloc();      // kernel page table
80102fe1:	e8 7a 3d 00 00       	call   80106d60 <kvmalloc>
  mpinit();        // detect other processors
80102fe6:	e8 85 01 00 00       	call   80103170 <mpinit>
  lapicinit();     // interrupt controller
80102feb:	e8 40 f7 ff ff       	call   80102730 <lapicinit>
  seginit();       // segment descriptors
80102ff0:	e8 1b 38 00 00       	call   80106810 <seginit>
  picinit();       // disable pic
80102ff5:	e8 46 03 00 00       	call   80103340 <picinit>
  ioapicinit();    // another interrupt controller
80102ffa:	e8 01 f3 ff ff       	call   80102300 <ioapicinit>
  consoleinit();   // console hardware
80102fff:	e8 2c da ff ff       	call   80100a30 <consoleinit>
  uartinit();      // serial port
80103004:	e8 c7 2a 00 00       	call   80105ad0 <uartinit>
  pinit();         // process table
80103009:	e8 22 08 00 00       	call   80103830 <pinit>
  tvinit();        // trap vectors
8010300e:	e8 0d 27 00 00       	call   80105720 <tvinit>
  binit();         // buffer cache
80103013:	e8 28 d0 ff ff       	call   80100040 <binit>
  fileinit();      // file table
80103018:	e8 c3 dd ff ff       	call   80100de0 <fileinit>
  ideinit();       // disk 
8010301d:	e8 be f0 ff ff       	call   801020e0 <ideinit>
...
80103034:	e8 d7 15 00 00       	call   80104610 <memmove>
...
80103079:	e8 d2 07 00 00       	call   80103850 <mycpu>
...
80103080:	74 de                	je     80103060 <main+0xa0>
    ...
    stack = kalloc();
80103082:	e8 29 f5 ff ff       	call   801025b0 <kalloc>
...
801030b1:	e8 ca f7 ff ff       	call   80102880 <lapicstartap>
...
801030dd:	e8 6e f4 ff ff       	call   80102550 <kinit2>
  userinit();      // first user process
801030e2:	e8 39 08 00 00       	call   80103920 <userinit>
  mpmain();        // finish this processor's setup
801030e7:	e8 64 fe ff ff       	call   80102f50 <mpmain>
...
8010311e:	68 79 74 10 80       	push   $0x80107479
80103123:	56                   	push   %esi
80103124:	e8 97 14 00 00       	call   801045c0 <memcmp>
...
801031d6:	68 96 74 10 80       	push   $0x80107496
801031db:	50                   	push   %eax
  conf = (struct mpconf*) P2V((uint) mp->physaddr);
801031dc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
801031df:	e8 dc 13 00 00       	call   801045c0 <memcmp>
...
80103278:	ff 24 95 bc 74 10 80 	jmp    *-0x7fef8b44(,%edx,4)
8010327f:	90                   	nop
...
801032a3:	68 7e 74 10 80       	push   $0x8010747e
...
8010332d:	68 9c 74 10 80       	push   $0x8010749c
...
801033d0:	00 00 00 
  initlock(&p->lock, "pipe");
801033d3:	68 d0 74 10 80       	push   $0x801074d0
801033d8:	50                   	push   %eax
801033d9:	e8 22 0f 00 00       	call   80104300 <initlock>
  (*f0)->type = FD_PIPE;
...
8010342a:	e8 91 da ff ff       	call   80100ec0 <fileclose>
...
8010343c:	e8 7f da ff ff       	call   80100ec0 <fileclose>
...
8010346f:	e8 8c 0f 00 00       	call   80104400 <acquire>
  if(writable){
...
8010348f:	e8 bc 0b 00 00       	call   80104050 <wakeup>
...
801034b3:	5d                   	pop    %ebp
    release(&p->lock);
801034b4:	e9 67 10 00 00       	jmp    80104520 <release>
801034b9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
801034c0:	83 ec 0c             	sub    $0xc,%esp
801034c3:	53                   	push   %ebx
801034c4:	e8 57 10 00 00       	call   80104520 <release>
    kfree((char*)p);
...
801034d4:	5d                   	pop    %ebp
    kfree((char*)p);
801034d5:	e9 16 ef ff ff       	jmp    801023f0 <kfree>
...
801034f4:	e8 57 0b 00 00       	call   80104050 <wakeup>
...
8010350d:	e8 ee 0e 00 00       	call   80104400 <acquire>
  for(i = 0; i < n; i++){
...
8010356d:	e8 2e 09 00 00       	call   80103ea0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103594:	e8 57 03 00 00       	call   801038f0 <myproc>
...
801035a4:	e8 77 0f 00 00       	call   80104520 <release>
        return -1;
...
801035f2:	e8 59 0a 00 00       	call   80104050 <wakeup>
  release(&p->lock);
801035f7:	89 1c 24             	mov    %ebx,(%esp)
801035fa:	e8 21 0f 00 00       	call   80104520 <release>
  return n;
...
80103620:	e8 db 0d 00 00       	call   80104400 <acquire>
...
80103655:	e8 46 08 00 00       	call   80103ea0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103673:	0f 84 8f 00 00 00    	je     80103708 <piperead+0xf8>
    if(myproc()->killed){
80103679:	e8 72 02 00 00       	call   801038f0 <myproc>
...
8010368e:	e8 8d 0e 00 00       	call   80104520 <release>
      return -1;
...
801036e7:	e8 64 09 00 00       	call   80104050 <wakeup>
  release(&p->lock);
801036ec:	89 34 24             	mov    %esi,(%esp)
801036ef:	e8 2c 0e 00 00       	call   80104520 <release>
  return i;
...
80103721:	e8 da 0c 00 00       	call   80104400 <acquire>
80103726:	83 c4 10             	add    $0x10,%esp
80103729:	eb 10                	jmp    8010373b <allocproc+0x2b>
8010372b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010372f:	90                   	nop
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103730:	83 c3 7c             	add    $0x7c,%ebx
80103733:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
8010374a:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->pid = nextpid++;
80103751:	89 43 10             	mov    %eax,0x10(%ebx)
80103754:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
80103757:	68 20 2d 11 80       	push   $0x80112d20
  p->pid = nextpid++;
8010375c:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103762:	e8 b9 0d 00 00       	call   80104520 <release>

  // Allocate kernel stack.
  if((p->kstack = kalloc()) == 0){
80103767:	e8 44 ee ff ff       	call   801025b0 <kalloc>
8010376c:	83 c4 10             	add    $0x10,%esp
8010376f:	89 43 08             	mov    %eax,0x8(%ebx)
80103772:	85 c0                	test   %eax,%eax
80103774:	74 53                	je     801037c9 <allocproc+0xb9>
    return 0;
  }
...
80103784:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103787:	c7 40 14 12 57 10 80 	movl   $0x80105712,0x14(%eax)
  p->context = (struct context*)sp;
8010378e:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103791:	6a 14                	push   $0x14
80103793:	6a 00                	push   $0x0
80103795:	50                   	push   %eax
80103796:	e8 d5 0d 00 00       	call   80104570 <memset>
...
8010379e:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
801037a1:	c7 40 10 e0 37 10 80 	movl   $0x801037e0,0x10(%eax)
}
...
801037ba:	e8 61 0d 00 00       	call   80104520 <release>
}
...
801037c8:	c3                   	ret    
    p->state = UNUSED;
801037c9:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return 0;
...
801037eb:	e8 30 0d 00 00       	call   80104520 <release>
...
80103836:	68 d5 74 10 80       	push   $0x801074d5
8010383b:	68 20 2d 11 80       	push   $0x80112d20
80103840:	e8 bb 0a 00 00       	call   80104300 <initlock>
}
...
801038f4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801038f7:	e8 b4 0a 00 00       	call   801043b0 <pushcli>
  c = mycpu();
801038fc:	e8 4f ff ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103901:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103907:	e8 b4 0b 00 00       	call   801044c0 <popcli>
}
...
80103924:	83 ec 04             	sub    $0x4,%esp
  p = allocproc();
80103927:	e8 e4 fd ff ff       	call   80103710 <allocproc>
8010392c:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010392e:	a3 b8 a5 10 80       	mov    %eax,0x8010a5b8
  if((p->pgdir = setupkvm()) == 0)
80103933:	e8 a8 33 00 00       	call   80106ce0 <setupkvm>
...
80103951:	e8 6a 30 00 00       	call   801069c0 <inituvm>
...
80103966:	e8 05 0c 00 00       	call   80104570 <memset>
...
801039bf:	68 05 75 10 80       	push   $0x80107505
801039c4:	50                   	push   %eax
801039c5:	e8 76 0d 00 00       	call   80104740 <safestrcpy>
  p->cwd = namei("/");
801039ca:	c7 04 24 0e 75 10 80 	movl   $0x8010750e,(%esp)
...
801039f3:	e8 28 0b 00 00       	call   80104520 <release>
}
...
80103a03:	68 ec 74 10 80       	push   $0x801074ec
...
80103a15:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a18:	e8 93 09 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103a1d:	e8 2e fe ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103a22:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a28:	e8 93 0a 00 00       	call   801044c0 <popcli>
  sz = curproc->sz;
...
80103a3b:	e8 70 2e 00 00       	call   801068b0 <switchuvm>
  return 0;
...
80103a5a:	e8 a1 30 00 00       	call   80106b00 <allocuvm>
...
80103a7a:	e8 b1 31 00 00       	call   80106c30 <deallocuvm>
...
80103a96:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a99:	e8 12 09 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103a9e:	e8 ad fd ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103aa3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa9:	e8 12 0a 00 00       	call   801044c0 <popcli>
  if((np = allocproc()) == 0){
80103aae:	e8 5d fc ff ff       	call   80103710 <allocproc>
...
80103ac8:	e8 e3 32 00 00       	call   80106db0 <copyuvm>
...
80103bde:	e8 1d 08 00 00       	call   80104400 <acquire>
...
80103c00:	e8 ab 2c 00 00       	call   801068b0 <switchuvm>
      swtch(&(c->scheduler), p->context);
80103c05:	58                   	pop    %eax
80103c06:	5a                   	pop    %edx
80103c07:	ff 73 1c             	pushl  0x1c(%ebx)
80103c0a:	57                   	push   %edi
      p->state = RUNNING;
80103c0b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c12:	e8 84 0b 00 00       	call   8010479b <swtch>
      switchkvm();
80103c17:	e8 84 2c 00 00       	call   801068a0 <switchkvm>
      c->proc = 0;
...
80103c2b:	00 00 00 
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c2e:	83 c3 7c             	add    $0x7c,%ebx
80103c31:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
80103c37:	75 b7                	jne    80103bf0 <scheduler+0x40>
    release(&ptable.lock);
80103c39:	83 ec 0c             	sub    $0xc,%esp
80103c3c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80103c3f:	68 20 2d 11 80       	push   $0x80112d20
80103c44:	e8 d7 08 00 00       	call   80104520 <release>
    if (ran == 0){
...
80103c64:	53                   	push   %ebx
  pushcli();
80103c65:	e8 46 07 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103c6a:	e8 e1 fb ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103c6f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c75:	e8 46 08 00 00       	call   801044c0 <popcli>
  if(!holding(&ptable.lock))
80103c7a:	83 ec 0c             	sub    $0xc,%esp
80103c7d:	68 20 2d 11 80       	push   $0x80112d20
80103c82:	e8 e9 06 00 00       	call   80104370 <holding>
80103c87:	83 c4 10             	add    $0x10,%esp
80103c8a:	85 c0                	test   %eax,%eax
80103c8c:	74 4f                	je     80103cdd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c8e:	e8 bd fb ff ff       	call   80103850 <mycpu>
...
80103ca7:	75 41                	jne    80103cea <sched+0x8a>
  intena = mycpu()->intena;
80103ca9:	e8 a2 fb ff ff       	call   80103850 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103cae:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103cb1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103cb7:	e8 94 fb ff ff       	call   80103850 <mycpu>
80103cbc:	83 ec 08             	sub    $0x8,%esp
80103cbf:	ff 70 04             	pushl  0x4(%eax)
80103cc2:	53                   	push   %ebx
80103cc3:	e8 d3 0a 00 00       	call   8010479b <swtch>
  mycpu()->intena = intena;
80103cc8:	e8 83 fb ff ff       	call   80103850 <mycpu>
}
...
80103d26:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d29:	e8 82 06 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103d2e:	e8 1d fb ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103d33:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d39:	e8 82 07 00 00       	call   801044c0 <popcli>
  if(curproc == initproc)
...
80103d6d:	75 e1                	jne    80103d50 <exit+0x30>
  begin_op();
80103d6f:	e8 2c ef ff ff       	call   80102ca0 <begin_op>
  iput(curproc->cwd);
80103d74:	83 ec 0c             	sub    $0xc,%esp
80103d77:	ff 76 68             	pushl  0x68(%esi)
80103d7a:	e8 d1 da ff ff       	call   80101850 <iput>
  end_op();
80103d7f:	e8 8c ef ff ff       	call   80102d10 <end_op>
  curproc->cwd = 0;
80103d84:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d8b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103d92:	e8 69 06 00 00       	call   80104400 <acquire>
...
80103dab:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
...
80103df7:	75 e7                	jne    80103de0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103df9:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103dfe:	eb 0a                	jmp    80103e0a <exit+0xea>
80103e00:	83 c0 7c             	add    $0x7c,%eax
80103e03:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
...
80103e2d:	68 5d 75 10 80       	push   $0x8010755d
80103e32:	e8 59 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e37:	83 ec 0c             	sub    $0xc,%esp
80103e3a:	68 50 75 10 80       	push   $0x80107550
...
80103e5c:	e8 9f 05 00 00       	call   80104400 <acquire>
  pushcli();
80103e61:	e8 4a 05 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103e66:	e8 e5 f9 ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103e6b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e71:	e8 4a 06 00 00       	call   801044c0 <popcli>
...
80103e89:	e8 92 06 00 00       	call   80104520 <release>
}
...
80103eac:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103eaf:	e8 fc 04 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103eb4:	e8 97 f9 ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103eb9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ebf:	e8 fc 05 00 00       	call   801044c0 <popcli>
  if(p == 0)
...
80103ee0:	e8 1b 05 00 00       	call   80104400 <acquire>
    release(lk);
80103ee5:	89 34 24             	mov    %esi,(%esp)
80103ee8:	e8 33 06 00 00       	call   80104520 <release>
  p->chan = chan;
...
80103f0a:	e8 11 06 00 00       	call   80104520 <release>
    acquire(lk);
...
80103f1b:	5d                   	pop    %ebp
    acquire(lk);
80103f1c:	e9 df 04 00 00       	jmp    80104400 <acquire>
...
80103f49:	68 6f 75 10 80       	push   $0x8010756f
80103f4e:	e8 3d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f53:	83 ec 0c             	sub    $0xc,%esp
80103f56:	68 69 75 10 80       	push   $0x80107569
...
80103f64:	53                   	push   %ebx
  pushcli();
80103f65:	e8 46 04 00 00       	call   801043b0 <pushcli>
  c = mycpu();
80103f6a:	e8 e1 f8 ff ff       	call   80103850 <mycpu>
  p = c->proc;
80103f6f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f75:	e8 46 05 00 00       	call   801044c0 <popcli>
  acquire(&ptable.lock);
80103f7a:	83 ec 0c             	sub    $0xc,%esp
80103f7d:	68 20 2d 11 80       	push   $0x80112d20
80103f82:	e8 79 04 00 00       	call   80104400 <acquire>
...
80103f9b:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
80103fb1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fb6:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
80103fe6:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103fe9:	e8 02 e4 ff ff       	call   801023f0 <kfree>
        freevm(p->pgdir);
80103fee:	5a                   	pop    %edx
...
80103ff2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ff9:	e8 62 2c 00 00       	call   80106c60 <freevm>
        release(&ptable.lock);
...
8010401e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80104025:	e8 f6 04 00 00       	call   80104520 <release>
        return pid;
...
80104043:	e8 d8 04 00 00       	call   80104520 <release>
      return -1;
...
8010408f:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
80104094:	75 e4                	jne    8010407a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104096:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
8010409d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801040a0:	c9                   	leave  
  release(&ptable.lock);
801040a1:	e9 7a 04 00 00       	jmp    80104520 <release>
...
801040bf:	e8 3c 03 00 00       	call   80104400 <acquire>
...
801040f6:	68 20 2d 11 80       	push   $0x80112d20
801040fb:	e8 20 04 00 00       	call   80104520 <release>
      return 0;
...
80104118:	e8 03 04 00 00       	call   80104520 <release>
  return -1;
...
8010416c:	74 ea                	je     80104158 <procdump+0x28>
      state = "???";
8010416e:	ba 80 75 10 80       	mov    $0x80107580,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104173:	83 f8 05             	cmp    $0x5,%eax
80104176:	77 11                	ja     80104189 <procdump+0x59>
80104178:	8b 14 85 e0 75 10 80 	mov    -0x7fef8a20(,%eax,4),%edx
      state = "???";
8010417f:	b8 80 75 10 80       	mov    $0x80107580,%eax
...
8010418e:	68 84 75 10 80       	push   $0x80107584
...
801041b5:	e8 66 01 00 00       	call   80104320 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801041cd:	68 a1 6f 10 80       	push   $0x80106fa1
...
801041fa:	68 f8 75 10 80       	push   $0x801075f8
...
80104255:	e8 46 fc ff ff       	call   80103ea0 <sleep>
  while (lk->locked) {
...
80104263:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104269:	e8 82 f6 ff ff       	call   801038f0 <myproc>
...
801042b4:	e8 97 fd ff ff       	call   80104050 <wakeup>
  release(&lk->lk);
...
80104393:	e8 b8 f4 ff ff       	call   80103850 <mycpu>
...
801043df:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
801043e0:	e8 6b f4 ff ff       	call   80103850 <mycpu>
...
80104434:	e8 17 f4 ff ff       	call   80103850 <mycpu>
  ebp = (uint*)v - 2;
80104439:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
8010443b:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
...
801044ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044f0:	e8 5b f3 ff ff       	call   80103850 <mycpu>
...
80104505:	68 0b 76 10 80       	push   $0x8010760b
8010450a:	e8 81 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 22 76 10 80       	push   $0x80107622
...
8010456a:	5d                   	pop    %ebp
  popcli();
8010456b:	e9 50 ff ff ff       	jmp    801044c0 <popcli>
...
801047b7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
801047ba:	e8 31 f1 ff ff       	call   801038f0 <myproc>
...
801047f7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801047fa:	e8 f1 f0 ff ff       	call   801038f0 <myproc>
...
80104855:	e8 96 f0 ff ff       	call   801038f0 <myproc>
...
80104863:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104866:	e8 85 f0 ff ff       	call   801038f0 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
801048a8:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
801048ab:	e8 40 f0 ff ff       	call   801038f0 <myproc>
...
80104944:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104947:	e8 a4 ef ff ff       	call   801038f0 <myproc>
...
80104b64:	e8 87 ed ff ff       	call   801038f0 <myproc>
...
80104ba9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104bab:	e8 40 ed ff ff       	call   801038f0 <myproc>
...
80104ce3:	78 2b                	js     80104d10 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104ce5:	e8 06 ec ff ff       	call   801038f0 <myproc>
...
80105127:	74 23                	je     8010514c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105129:	e8 c2 e7 ff ff       	call   801038f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801052e5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801052e8:	e8 03 e6 ff ff       	call   801038f0 <myproc>
...
801054a8:	e8 b3 de ff ff       	call   80103360 <pipealloc>
...
801054b7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801054b9:	e8 32 e4 ff ff       	call   801038f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801054f7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801054fa:	e8 f1 e3 ff ff       	call   801038f0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105516:	75 f0                	jne    80105508 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105518:	e8 d3 e3 ff ff       	call   801038f0 <myproc>
...
{
  return fork();
80105550:	e9 3b e5 ff ff       	jmp    80103a90 <fork>
...
80105563:	83 ec 08             	sub    $0x8,%esp
  exit();
80105566:	e8 b5 e7 ff ff       	call   80103d20 <exit>
...
{
  return wait();
80105570:	e9 eb e9 ff ff       	jmp    80103f60 <wait>
...
8010559e:	e8 0d eb ff ff       	call   801040b0 <kill>
...
801055c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055c6:	e8 25 e3 ff ff       	call   801038f0 <myproc>
...
801055e7:	78 27                	js     80105610 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
801055e9:	e8 02 e3 ff ff       	call   801038f0 <myproc>
  if(growproc(n) < 0)
...
801055f6:	e8 15 e4 ff ff       	call   80103a10 <growproc>
...
8010566d:	e8 2e e8 ff ff       	call   80103ea0 <sleep>
  while(ticks - ticks0 < n){
...
8010567f:	73 2f                	jae    801056b0 <sys_sleep+0x90>
    if(myproc()->killed){
80105681:	e8 6a e2 ff ff       	call   801038f0 <myproc>
...
80105800:	e8 eb e0 ff ff       	call   801038f0 <myproc>
...
80105820:	e8 ab e0 ff ff       	call   801038d0 <cpuid>
...
80105831:	e8 ba e0 ff ff       	call   801038f0 <myproc>
80105836:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105839:	e8 b2 e0 ff ff       	call   801038f0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105862:	e8 89 e0 ff ff       	call   801038f0 <myproc>
...
8010586e:	e8 7d e0 ff ff       	call   801038f0 <myproc>
80105873:	85 c0                	test   %eax,%eax
80105875:	74 1d                	je     80105894 <trap+0xc4>
80105877:	e8 74 e0 ff ff       	call   801038f0 <myproc>
...
80105894:	e8 57 e0 ff ff       	call   801038f0 <myproc>
80105899:	85 c0                	test   %eax,%eax
8010589b:	74 0b                	je     801058a8 <trap+0xd8>
8010589d:	e8 4e e0 ff ff       	call   801038f0 <myproc>
...
801058a6:	74 38                	je     801058e0 <trap+0x110>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058a8:	e8 43 e0 ff ff       	call   801038f0 <myproc>
801058ad:	85 c0                	test   %eax,%eax
801058af:	74 1d                	je     801058ce <trap+0xfe>
801058b1:	e8 3a e0 ff ff       	call   801038f0 <myproc>
...
801058e4:	75 c2                	jne    801058a8 <trap+0xd8>
    yield();
801058e6:	e8 65 e5 ff ff       	call   80103e50 <yield>
801058eb:	eb bb                	jmp    801058a8 <trap+0xd8>
801058ed:	8d 76 00             	lea    0x0(%esi),%esi
    if(cpuid() == 0){
801058f0:	e8 db df ff ff       	call   801038d0 <cpuid>
...
801058fd:	e8 4e cf ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105902:	e8 e9 df ff ff       	call   801038f0 <myproc>
...
8010591d:	e8 2e cf ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105922:	e8 c9 df ff ff       	call   801038f0 <myproc>
...
8010593d:	e8 0e cf ff ff       	call   80102850 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105942:	e8 a9 df ff ff       	call   801038f0 <myproc>
...
8010595f:	e8 6c df ff ff       	call   801038d0 <cpuid>
...
80105976:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105979:	e8 72 df ff ff       	call   801038f0 <myproc>
...
801059cf:	5d                   	pop    %ebp
      exit();
801059d0:	e9 4b e3 ff ff       	jmp    80103d20 <exit>
801059d5:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
801059d8:	e8 43 e3 ff ff       	call   80103d20 <exit>
...
80105a1c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      exit();
80105a20:	e8 fb e2 ff ff       	call   80103d20 <exit>
80105a25:	eb 85                	jmp    801059ac <trap+0x1dc>
80105a27:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105a2a:	e8 a1 de ff ff       	call   801038d0 <cpuid>
...
801067f9:	68 c6 71 10 80       	push   $0x801071c6
...
80106813:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106816:	e8 b5 d0 ff ff       	call   801038d0 <cpuid>
  pd[0] = size-1;
...
801068d4:	0f 84 c2 00 00 00    	je     8010699c <switchuvm+0xec>
  pushcli();
801068da:	e8 d1 da ff ff       	call   801043b0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801068df:	e8 6c cf ff ff       	call   80103850 <mycpu>
801068e4:	89 c6                	mov    %eax,%esi
801068e6:	e8 65 cf ff ff       	call   80103850 <mycpu>
801068eb:	89 c7                	mov    %eax,%edi
801068ed:	e8 5e cf ff ff       	call   80103850 <mycpu>
801068f2:	83 c7 08             	add    $0x8,%edi
801068f5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068f8:	e8 53 cf ff ff       	call   80103850 <mycpu>
...
80106989:	5d                   	pop    %ebp
  popcli();
8010698a:	e9 31 db ff ff       	jmp    801044c0 <popcli>
...
80106dc3:	0f 84 a0 00 00 00    	je     80106e69 <copyuvm+0xb9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106dc9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106dcc:	85 c9                	test   %ecx,%ecx
80106dce:	0f 84 95 00 00 00    	je     80106e69 <copyuvm+0xb9>
80106dd4:	31 f6                	xor    %esi,%esi
80106dd6:	eb 4e                	jmp    80106e26 <copyuvm+0x76>
...
80106df1:	57                   	push   %edi
80106df2:	50                   	push   %eax
80106df3:	e8 18 d8 ff ff       	call   80104610 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106df8:	58                   	pop    %eax
80106df9:	5a                   	pop    %edx
80106dfa:	53                   	push   %ebx
80106dfb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106dfe:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106e01:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106e06:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106e0c:	52                   	push   %edx
80106e0d:	89 f2                	mov    %esi,%edx
80106e0f:	e8 bc f8 ff ff       	call   801066d0 <mappages>
80106e14:	83 c4 10             	add    $0x10,%esp
80106e17:	85 c0                	test   %eax,%eax
80106e19:	78 39                	js     80106e54 <copyuvm+0xa4>
  for(i = 0; i < sz; i += PGSIZE){
80106e1b:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106e21:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106e24:	76 43                	jbe    80106e69 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106e26:	8b 45 08             	mov    0x8(%ebp),%eax
80106e29:	31 c9                	xor    %ecx,%ecx
80106e2b:	89 f2                	mov    %esi,%edx
80106e2d:	e8 1e f8 ff ff       	call   80106650 <walkpgdir>
80106e32:	85 c0                	test   %eax,%eax
80106e34:	74 3e                	je     80106e74 <copyuvm+0xc4>
    if(!(*pte & PTE_P))
80106e36:	8b 18                	mov    (%eax),%ebx
80106e38:	f6 c3 01             	test   $0x1,%bl
80106e3b:	74 44                	je     80106e81 <copyuvm+0xd1>
    pa = PTE_ADDR(*pte);
80106e3d:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106e3f:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
80106e45:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106e4b:	e8 60 b7 ff ff       	call   801025b0 <kalloc>
80106e50:	85 c0                	test   %eax,%eax
80106e52:	75 8c                	jne    80106de0 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106e57:	ff 75 e0             	pushl  -0x20(%ebp)
80106e5a:	e8 01 fe ff ff       	call   80106c60 <freevm>
  return 0;
80106e5f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80106e77:	68 14 79 10 80       	push   $0x80107914
80106e7c:	e8 0f 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80106e81:	83 ec 0c             	sub    $0xc,%esp
80106e84:	68 2e 79 10 80       	push   $0x8010792e
80106e89:	e8 02 95 ff ff       	call   80100390 <panic>
...
80106e9e:	e8 ad f7 ff ff       	call   80106650 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106f06:	e8 05 d7 ff ff       	call   80104610 <memmove>
    len -= n;
    buf += n;
